...
#include "rtwtypes.h"
#include "C:\ProgramData\MATLAB\SupportPackages\R2025b\toolbox\target\supportpackages\parrot\include\HAL.h"
...
typedef struct P_MeasurementUpdate_flightControlSystem_o_T_
  P_MeasurementUpdate_flightControlSystem_o_T;

/* Parameters for system: '<S105>/Enabled Subsystem' */
typedef struct P_EnabledSubsystem_flightControlSystem_i_T_
  P_EnabledSubsystem_flightControlSystem_i_T;
...
typedef struct P_MeasurementUpdate_flightControlSystem_i_T_
  P_MeasurementUpdate_flightControlSystem_i_T;

/* Parameters for system: '<S368>/Enabled Subsystem' */
typedef struct P_EnabledSubsystem_flightControlSystem_g_T_
  P_EnabledSubsystem_flightControlSystem_g_T;
