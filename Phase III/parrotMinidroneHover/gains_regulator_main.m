%SIM rho 0.05 --> F3 CAN BE BETTER
%SIM rho 0.75 --> M1    WORKS BUT SLOW  --
%SIM rho 5 --> M2   ~6-1.5ms time to get WORKS BUT SLOW  
%SIM rho 0.2 -->M3
...
r2_max  = 6;     th1_max = 1;   v2_max  = 25;   w1_max = 1.5;   xi2_max = 14;
%r2_max  = 6;     th1_max = 0.2;   v2_max  = 1.5;   w1_max = 1;   xi2_max = 14; %4 -- REAL 14
% SS3 – Lateral-Pitch  [r1,    th2,   v1,    w2,    xi_r1]
r1_max  = 6;     th2_max = 1;   v1_max  = 25;   w2_max = 1.5;   xi3_max = 14;   %12 2.5 
%r1_max  = 6;     th2_max = 0.20;   v1_max  = 1;   w2_max = 1;   xi3_max = 14; %4  -- REAL 14
%2.5                                %1.5

% SS4 – Yaw            [th3,   w3,    xi_th3]
%th3_max = 0.1;  w3_max  = 10;     xi4_max = 0.2;
th3_max = pi;  w3_max  = 5;     xi4_max = 0.6*pi;
...
%{
R_lqr1 = 0.05;     %DONE
R_lqr2 = 0.002; %DONE      %2*(10^8) NO     
R_lqr3 = 0.002;            % 2*(10^6) BEST 
R_lqr4 = 0.2; %DONE
%}
...
R_lqr1 = 5;     %DONE
R_lqr2 = 2*(10^5); %DONE 5     %2*(10^8) NO     
R_lqr3 = 2*(10^5);            % 2*(10^6) BEST 
%R_lqr2 = 5000; %DONE      %2*(10^8) NO     
%R_lqr3 = 5000;            % 2*(10^6) BEST 
...
ki1 = Kid1; ki2 = Kid2; ki3 = Kid3; ki4 = Kid4;
